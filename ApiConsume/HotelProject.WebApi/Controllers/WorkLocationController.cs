...
namespace HotelProject.WebApi.Controllers
{
    ...
    public class WorkLocationController : ControllerBase
    {
        ...
        {
            var workLocationtlist = _workLocationService.TGetList();
            return Ok(workLocationtlist);
        }
        ...
        {
            var deleteWorkLocation = _workLocationService.TGetByID(id);
            _workLocationService.TDelete(deleteWorkLocation);
            return Ok();
        }
        ...
        {
            var getWorkLocation = _workLocationService.TGetByID(id);
            return Ok(getWorkLocation);
        }
    }
}
