...
namespace HotelProject.WebApi.Controllers
{
    ...
    public class MessageCategoryController : ControllerBase
    {
        ...
        {
            var messageCategoryList = _messageCategoryService.TGetList();
        ...
        {
            var deleteMessageCategory = _messageCategoryService.TGetByID(id);
            _messageCategoryService.TDelete(deleteMessageCategory);
            return Ok();
        }
        ...
        {
            var getMessageCategory = _messageCategoryService.TGetByID(id);
            return Ok(getMessageCategory);
        }
    }
}
